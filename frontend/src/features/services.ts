...
export async function getAllCaptiBookCollectionApi(): Promise<CaptiBookData[]> {
  const config = {
    ...
    url: "http://localhost:5000/api/get-all-bookcollection-data",
    headers: {
...
export async function addOneBookCollectionDataAxios(
  ...
  let config: AxiosRequestConfig = {
    method: "post",
    maxBodyLength: Infinity,
    url: "http://localhost:5000/api/add-one-bookcollection-data",
    headers: {
      "Content-Type": "application/json",
    },
    data: data,
...
export async function deleteOneBookCollectionDataAxios(id: ObjectId) {
  let config = {
    method: "delete",
    maxBodyLength: Infinity,
    url: `http://localhost:5000/api/delete-one-bookcollection-data/${id}`,
    headers: {},
    withCredentials: true,
  };
...
export async function recordProductivityDataAxios(
  ...
  let config = {
    method: "post",
    maxBodyLength: Infinity,
    url: "http://localhost:5000/api/record-productivity-data",
    headers: {
      "Content-Type": "application/json",
    },
    data: data,
...
export async function getAllProductivityDataAxios(): Promise<Session[]> {
  const config = {
    method: "get",
    maxBodyLength: Infinity,
    url: "http://localhost:5000/api/get-all-productivity-data",
    headers: {
      "Content-Type": "application/json",
    },
    withCredentials: true,
...
export async function addOneSummaryData(summaryData: SummaryItemLocal) {
  ...
  let config = {
    method: "post",
    maxBodyLength: Infinity,
    url: "http://localhost:5000/api/add-one-summary-data",
    headers: {
      "Content-Type": "application/json",
    },
    data: data,
...
export async function updateOneSummaryData(summaryData: SummaryItem) {
  ...
  let config = {
    method: "patch",
    maxBodyLength: Infinity,
    url: `http://localhost:5000/api/update-one-summary-data/${summaryData._id}`,
    headers: {
      "Content-Type": "application/json",
    },
    data: data,
...
export async function deleteOneSummaryData(summaryId: ObjectId) {
  let config = {
    method: "delete",
    maxBodyLength: Infinity,
    url: `http://localhost:5000/api/delete-one-summary-data/${summaryId}`,
    headers: {
      "Content-Type": "application/json",
    },
    withCredentials: true,
...
export async function addOneTermData(termData: TermItemLocal) {
  ...
  let config = {
    method: "post",
    maxBodyLength: Infinity,
    url: "http://localhost:5000/api/add-one-term-data",
    headers: {
      "Content-Type": "application/json",
    },
    data: data,
...
export async function updateOneTermData(termData: TermItem) {
  ...
  let config = {
    method: "patch",
    maxBodyLength: Infinity,
    url: `http://localhost:5000/api/update-one-term-data/${termData._id}`,
    headers: {
      "Content-Type": "application/json",
    },
    data: data,
...
export async function deleteOneTermData(termId: ObjectId) {
  let config = {
    method: "delete",
    maxBodyLength: Infinity,
    url: `http://localhost:5000/api/delete-one-term-data/${termId}`,
    headers: {
      "Content-Type": "application/json",
    },
    withCredentials: true,
...
export async function addOneQuoteData(quoteData: QuoteItemLocal) {
  ...
  let config = {
    method: "post",
    maxBodyLength: Infinity,
    url: "http://localhost:5000/api/add-one-quote-data",
    headers: {
      "Content-Type": "application/json",
    },
    data: data,
...
export async function updateOneQuoteData(quoteData: QuoteItem) {
  ...
  let config = {
    method: "patch",
    maxBodyLength: Infinity,
    url: `http://localhost:5000/api/update-one-quote-data/${quoteData._id}`,
    headers: {
      "Content-Type": "application/json",
    },
    data: data,
...
export async function deleteOneQuoteData(quoteId: ObjectId) {
  let config = {
    method: "delete",
    maxBodyLength: Infinity,
    url: `http://localhost:5000/api/delete-one-quote-data/${quoteId}`,
    headers: {
      "Content-Type": "application/json",
    },
    withCredentials: true,
...
export async function updateUserImageAxios(base64: string) {
  ...
  const config = {
    method: "post",
    url: "http://localhost:5000/api/update-user-image",
    headers: {
      "Content-Type": "application/json",
    },
    withCredentials: true,
...
export async function updateUserDisplayNameAxios(displayName: string) {
  ...
  const config = {
    method: "post",
    url: "http://localhost:5000/api/update-user-display-name",
    headers: {
      "Content-Type": "application/json",
    },
    withCredentials: true,
...
export async function updateUserThemeAxios(theme: 0 | 1) {
  ...
  const config = {
    method: "post",
    url: "http://localhost:5000/api/update-user-theme",
    headers: {
      "Content-Type": "application/json",
    },
    withCredentials: true,
